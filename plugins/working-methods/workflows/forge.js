...
const PHASES = [
  ...
  { id: 'plan', title: 'Global plan + execution proposal (multi-agent by default)',
    invokes: 'superpowers:writing-plans if installed (NOT a declared dep) — fallback: plain versioned plan.md; + execution proposal (worktrees · context pack · model per unit)',
  ...
  { id: 'verify', title: 'Verify (matrix, not diff: reviewers + completeness-critic + design-review if UI)',
    invokes: 'forge-methodology:independent-verifier · forge-methodology:completeness-critic · design-review (on UI diff)',
